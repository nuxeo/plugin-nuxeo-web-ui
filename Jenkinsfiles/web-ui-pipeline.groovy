properties([
    ...
    parameters([
            ...
            choice(name: 'BASE_BRANCH', choices: ['9.10'], description: 'The branch to fallback on when $BRANCH is not found.'),
            string(name: 'SLAVE', defaultValue: 'SLAVE910', description: 'Slave label to be used.', trim: false),
